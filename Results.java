...
//This is your "value" class from the demo.
...
public class Results {
        ...
        public String toString(){
            return "Results{" + ", section=" + section + '\'' + ", subsection=" + subsection + '\'' + ", title=" + title + '\'' + ", abstract=" +
                    abtract + '\'' + ", url=" + url + '\'' + ", uri=" + uri + '\'' + ", byline=" + byline + '\'' + ", item_type=" + item_type + '\''
                    + ", updated_date=" + updated_date + '\'' + ", created_date=" + created_date + '\'' + ", published_date=" + published_date +
                    '\'' + ", material_type_facet=" + material_type_facet + '\'' + ", kicker=" + kicker + '\'' + ", des_facet=" + des_facet + '\''
                    + ", org_facet=" + org_facet + '\'' + ", per_facet=" + per_facet + '\'' + ", geo_facet=" + geo_facet + '\'' + ", multimedia" +
                    multimedia + '\'' + '}';
        }
